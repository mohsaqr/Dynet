...
This is a pkgdown **article**, not a package vignette: it is built for the
website from the working tree and is not part of the source tarball, because
it runs the whole study end to end and draws every temporal view Dynet has.
