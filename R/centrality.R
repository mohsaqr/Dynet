...
#' @param damping Damping factor for PageRank, at either scope; a single
#'   number strictly between zero and one, `0.85` by default. In the temporal
#'   formulation it is the paper's jumping probability, so each extra step of
#'   a temporal walk is worth `damping` times the last.
