...
plot(durations(dn, unit = "pair", measure = "total"))
```
...
plot(snapshots(dn, step = 1, window = 1))
```
...
plot(path_network(paths(dn, from = "Inquiring")), layout = "oval")
```
