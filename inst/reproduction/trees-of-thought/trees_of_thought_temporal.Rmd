...
directed_degree <- centrality_series(
  dn, measure = "degree", mode = "in",
  step = 0.1, window = 0.1
)
out_degree <- centrality_series(
...
prestige_indegree <- centrality_series(
  dn, measure = "prestige", prestige = "indegree",
  step = 0.1, window = 0.1
)
prestige_eigenvector <- centrality_series(
  dn, measure = "prestige", prestige = "eigenvector",
  step = 0.1, window = 0.1
)
prestige_domain <- centrality_series(
  dn, measure = "prestige", prestige = "domain",
  step = 0.1, window = 0.1
)
prestige_proximity <- centrality_series(
...
temporal_centrality <- path_centrality(
  dn,
...
group_structure <- metrics(group_dn,
...
verbs_used <- c(
  ...
  "durations", "centrality_series", "path_centrality", "reachability", "paths",
